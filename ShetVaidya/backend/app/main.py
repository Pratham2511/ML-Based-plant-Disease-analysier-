...
def build_disease_data(class_name: str) -> dict:
    ...
    fallbacks = {
        "healthy": {
            "description": "The money plant leaf appears healthy with no visible signs of disease or stress.",
            "cause": "N/A — plant is in good condition.",
            "treatment": "Continue regular care. Water when the top inch of soil feels dry. Ensure indirect bright light.",
        },
        "unhealthy": {
            "description": "The leaf shows signs of disease, pest damage, fungal infection, or physical stress. Common symptoms include brown spots, wilting, black edges, or lesions.",
            "cause": "Possible causes include fungal infections, bacterial leaf spot, pest infestation from spider mites or mealybugs, or overwatering.",
            "treatment": "Isolate the plant immediately. Remove affected leaves. Apply neem oil spray every 3 days for 2 weeks. Avoid overwatering.",
        },
        "yellow": {
            "description": "The leaf has turned yellow which typically indicates a nutrient deficiency, overwatering, underwatering, or too much direct sunlight.",
            "cause": "Most common causes are overwatering, nitrogen or magnesium deficiency, too much direct sun, or natural ageing of lower leaves.",
            "treatment": "Check soil moisture. Feed with balanced NPK 20-20-20 fertiliser once every 2 weeks. Move plant to bright indirect light. Remove fully yellow leaves.",
        },
        "not_a_leaf": {
            "description": "The uploaded image does not appear to be a money plant leaf.",
            "cause": "N/A",
            "treatment": "Please upload a clear well-lit photograph of a money plant leaf and try again.",
        },
    }
    fb = fallbacks.get(class_name, {})
    return {
        "disease_name": entry.get("disease_name") or clean_class_name(class_name),
        "description": entry.get("description") or fb.get("description", "Analysis complete."),
        "cause": entry.get("cause") or fb.get("cause", "See treatment recommendations."),
        "treatment": entry.get("treatment") or fb.get("treatment", "Consult your local agriculture officer."),
